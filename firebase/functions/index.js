...
exports.ffPrivateApiCall2 = functions
  .runWith({ minInstances: 0, maxInstances: 1, timeoutSeconds: 120 })
...
exports.ffPrivateApiCall2V2 = onRequest(
  { cors: true, minInstances: 0, maxInstances: 1, timeoutSeconds: 120 },
  async (req, res) => {
    try {
      const context = {
