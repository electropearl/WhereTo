                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          StreamBuilder<List<SpecialsRecord>>(
                                            stream: querySpecialsRecord(
                                              parent:
                                                  widget.venueRef?.reference,
                                              queryBuilder: (specialsRecord) =>
                                                  specialsRecord
                                                      .orderBy('startDate'),
                                            ),
