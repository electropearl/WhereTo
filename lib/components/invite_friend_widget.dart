...
/// Create a component that will allow user to select from friends list also
/// include a option to send send a friend request via text.
class InviteFriendWidget extends StatefulWidget {
  const InviteFriendWidget({
    super.key,
    this.friendsExisting,
    required this.status,
    this.groupRef,
  });

  final List<DocumentReference>? friendsExisting;
  final String? status;
  final GroupsRecord? groupRef;
                                  ...
                                  if (!widget.groupRef!.memberUserIds
                                    ...
                                    await GroupInvitesRecord.collection
                                      ...
                                      ...createGroupInvitesRecordData(
                                        groupRef: widget.groupRef?.reference,
                                        groupName: widget.groupRef?.groupName,
