...
class _MatchesWidgetState extends State<MatchesWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MATCHES_PAGE_matches_ON_INIT_STATE');
      logFirebaseEvent('matches_firestore_query');
      _model.userADocRef = await queryMatchesRecordOnce(
      ...
      logFirebaseEvent('matches_firestore_query');
      _model.userBDocRef = await queryMatchesRecordOnce(
        queryBuilder: (matchesRecord) => matchesRecord.where(
          'userBId',
          isEqualTo: currentUserReference,
        ),
      );
      logFirebaseEvent('matches_update_app_state');
      FFAppState().matches = _model.userADocRef!
          .map((e) => e.reference)
          .toList()
          .toList()
      ...
      for (int loop1Index = 0;
          loop1Index <=
              valueOrDefault<int>(
                _model.userBDocRef?.length,
                0,
              );
          loop1Index++) {
        final currentLoop1Item = _model.userBDocRef![loop1Index];
        logFirebaseEvent('matches_update_app_state');
        FFAppState().addToMatches(currentLoop1Item.reference);
        safeSetState(() {});
      }
      logFirebaseEvent('matches_update_app_state');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final matches = FFAppState().matches.toList();
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, matchesIndex) {
                            ...
                            return StreamBuilder<MatchesRecord>(
                              stream: MatchesRecord.getDocument(matchesItem),
                              builder: (context, snapshot) {
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: () {
                                        if (containerMatchesRecord.status ==
                                            'denied') {
                                          return FlutterFlowTheme.of(context)
                                              .secondary;
                                        } else if (containerMatchesRecord
                                                .status ==
                                            'pending') {
                                          return FlutterFlowTheme.of(context)
                                              .warning;
                                  ...
                                  child: Stack(
                                    children: [
                                      if (containerMatchesRecord.userAId !=
                                          currentUserReference)
                                        Padding(
                                          padding: EdgeInsets.all(16.0),
                                          child: StreamBuilder<UsersRecord>(
                                            stream: UsersRecord.getDocument(
                                                containerMatchesRecord
                                                    .userAId!),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              if (!snapshot.hasData) {
                                                                    ...
                                                                    if (containerMatchesRecord
                                                                      ...
                                                                      FFButtonWidget(
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'MATCHES_PAGE_ACCEPT_BTN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Button_navigate_to');

                                                                          context
                                                                              .goNamed(
                                                                            MatchDecideWidget.routeName,
                                                                            queryParameters:
                                                                                {
                                                                            ...
                                                                            extra: <String,
                                                                              ...
                                                                              'matchRef': containerMatchesRecord,
                                                                            },
                                                                          );
                                                                        },
                                                                        text:
                                      ...
                                      if (containerMatchesRecord.userBId !=
                                          currentUserReference)
                                        Padding(
                                          padding: EdgeInsets.all(16.0),
                                          child: StreamBuilder<UsersRecord>(
