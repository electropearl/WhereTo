...
class _GroupInviteWidgetState extends State<GroupInviteWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'GroupInvite'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('GROUP_INVITE_GroupInvite_ON_INIT_STATE');
      logFirebaseEvent('GroupInvite_firestore_query');
      ...
      logFirebaseEvent('GroupInvite_update_app_state');
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('GROUP_INVITE_arrow_back_rounded_ICN_ON_T');
                                                              ...
                                                              children: [
                                                                FFButtonWidget(
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'GROUP_INVITE_PAGE_DECLINE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_backend_call');
                                                                ...
                                                                FFButtonWidget(
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'GROUP_INVITE_PAGE_ACCEPT_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_backend_call');
                                                              ...
                                                              children: [
                                                                ...
                                                                FFButtonWidget(
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'GROUP_INVITE_VIEW_PROFILE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_navigate_to');
                                                              ...
                                                              children: [
                                                                FFButtonWidget(
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'GROUP_INVITE_PAGE_REMOVE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_backend_call');
                                                                    await invitesListItem
                                                                        .reference
