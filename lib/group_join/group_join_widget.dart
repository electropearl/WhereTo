...
import 'group_join_model.dart';
export 'group_join_model.dart';

/// Interface for creating or joining a group.
///
/// Includes:
/// - Set group name (optional)
/// - Add friends manually or generate a join code
/// - Invite nearby users
/// - Assign initial interest tags to help with vibe labeling
class GroupJoinWidget extends StatefulWidget {
  const GroupJoinWidget({super.key});

  static String routeName = 'GroupJoin';
  static String routePath = '/groupJoin';

  @override
  State<GroupJoinWidget> createState() => _GroupJoinWidgetState();
}

class _GroupJoinWidgetState extends State<GroupJoinWidget> {
  late GroupJoinModel _model;
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Select tags that represent your group\'s vibe and interests\n\n(Note that 3 is the recomended highest amount, due to it increasing match rate.)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              font: GoogleFonts.inter(
                                      ...
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ...
                                          ChipData('Easy Going'),
                                          ChipData('Faded'),
                                          ChipData('Intellectual'),
                                          ChipData('Networking'),
                                          ChipData('Long-Term'),
                                          ChipData('One Night'),
                                          ChipData('Funny'),
                                          ChipData('New To Town'),
                                          ChipData('Grew Up Here')
                                        ],
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'Interest tags help others discover your group and create better matches for activities',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                                      .override(
                              ...
                              for (int loop1Index = 0;
                                ...
                                await GroupInvitesRecord.collection.doc().set({
                                  ...createGroupInvitesRecordData(
                                    groupRef: _model.group?.reference,
                                    groupName: _model.group?.groupName,
                                    senderRef: currentUserReference,
                                    recieverRef: currentLoop1Item,
                                    status: 'new',
                                  ),
                                  ...mapToFirestore(
                                    {
