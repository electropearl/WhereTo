...
export 'owner_model.dart';

/// For business owners to manage their venue.
///
/// Includes:
/// - View venue stats: users seen, vibe feedback, RSVP counts
/// - Add/edit specials and events
/// - Activate or boost promotions
/// - Subscription status and renew button
class OwnerWidget extends StatefulWidget {
  const OwnerWidget({super.key});

  static String routeName = 'owner';
  static String routePath = '/owner';
