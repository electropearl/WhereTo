...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: OwnerWidget.routeName,
          path: OwnerWidget.routePath,
          builder: (context, params) => OwnerWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            name: GroupManagementWidget.routeName,
            path: GroupManagementWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'groupManagement')
                : NavBarPage(
                    initialPage: 'groupManagement',
                    page: GroupManagementWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
          name: SocialVibesWidget.routeName,
          path: SocialVibesWidget.routePath,
          builder: (context, params) => SocialVibesWidget(),
        ),
        FFRoute(
          name: InterestSelectionWidget.routeName,
          path: InterestSelectionWidget.routePath,
          builder: (context, params) => InterestSelectionWidget(),
        ),
        FFRoute(
          name: LocationPermissionWidget.routeName,
          path: LocationPermissionWidget.routePath,
          builder: (context, params) => LocationPermissionWidget(),
        ),
        FFRoute(
